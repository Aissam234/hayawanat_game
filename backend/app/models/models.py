...
class User(Base):
    ...
    avatar_id = Column(String(20), nullable=False, default="lion", server_default="lion")
...
class Question(Base):
    ...
    question_type = Column(String(10), nullable=False, default="text", server_default="text")
    audio_duration_ms = Column(Integer, nullable=True)
    client_request_id = Column(UUID(as_uuid=True), nullable=True, unique=True)
